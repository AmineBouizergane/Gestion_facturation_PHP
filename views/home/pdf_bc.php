    ...
    <tr align="left">
        <td  width="70%" >
            <table cellpadding  ="6">
                <tr width="50%" align="right">
                    <td><strong> Bon de Commande N° '.$numero_bc.' </strong></td>
                </tr>
                <tr width="34%">
        ...
        <td  width="30%">
            <table  cellpadding  ="6">
                ...
                <tr width="34%">
                    <td align="right"> Bir Jdid  le '.date("d/m/Y", $date).'</td>
                </tr >
            </table>
        </td>
    </tr>
...
<table  width="100%"   cellpadding  ="3" align="left">
    <tr align="left" >
        <td  width="10%" style="border-left:1px solid black;border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;" ><strong>Code article</strong></td>
        <td  width="35%" style="border-left:1px solid black;border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;" ><strong>Désignation</strong></td>
        ...
        <td  width="20%" style="border-left:1px solid black;border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;" ><strong>Total H.T</strong></td>
    </tr>
</table>
EOF;
$pdf->writeHTML($tbl, true, false, false, false, '');
...
foreach($det_bc as $k=>$v) {
   ...
   <table cellspacing="0"    align="left"  >
                 ...
                 <tr >
                     <td style="width: 10%;border-left:1px solid black;border-bottom:1px solid black;"> </td>
                     <td style="width: 35%;border-left:1px solid black;border-bottom:1px solid black;"  align="left">  '.$v['designiation'].'</td>
                     ...
                     <td style="width: 15%;border-left:1px solid black;border-bottom:1px solid black;" >  '.$v['prix_unitaire'].'</td>
                     <td style="width: 20%;border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;" align="center">  '.$v['prix_total'].'</td>
...
<table  width="100%"   cellpadding  ="3" align="left">
    <tr align="left" >
        ...
        <td  width="20%" align="center" style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;">$total_ht</td>
    </tr>
</table>
EOF;
$pdf->writeHTML($tbl, true, false, false, false, '');
...
<table  width="100%"   cellpadding  ="3" align="left">
    <tr align="left" >
        ...
        <td  width="10%"></td>
        <td  width="15%">TVA</td>
        <td  width="20%" align="center" style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;">$tva</td>
    </tr>
</table>
EOF;
$pdf->writeHTML($tbl, true, false, false, false, '');
...
<table  width="100%"   cellpadding  ="3" align="left">
    <tr align="left" >
        ...
        <td  width="20%" align="center" style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;border-top:1px solid black;">$total</td>
    </tr>
</table>
EOF;
$pdf->writeHTML($tbl, true, false, false, false, '');
...
<table class="first" width="100%"   cellpadding  ="3">
    <tr align="right">
        <td width="100%" style="text-decoration: underline;">SERVICE ACHAT</td>
    </tr>
</table>
EOF;
$pdf->writeHTML($tbl, true, false, false, false, '');

$pdf->Output('BC_N'.$numero_bc.'_'.$societe.'.pdf', 'I');
