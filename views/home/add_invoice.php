			...
			<div class="sidebar-inner slimscroll">
                ...
                <ul>
						...
						<li class="submenu active">
							...
							<ul>
								<li><a href="<?=WEB_ROOT?>home/add_invoice" class="active">Crée facture</a></li>
			...
			<div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item active">Crée une facture</li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<form id="cart" action="<?=WEB_ROOT?>home/save_facture" method='post'>
									<div class="row">
										...
										<table class="table table-stripped table-center table-hover" name="cart">
											...
											<tbody>
												<tr class="line_items" >
													...
													<td>
														<input type="number" name="qte[]" min="1" class="form-control" required>
													</td>
													<td>
														<input type="number" name="price_unit[]" min="0"  step="0.20" class="form-control" required>
													</td>
													<td>
									...
									<div class="text-right mt-4">
										<button type="submit" class="btn btn-primary">Crée facture</button>
									</div>
								</form>
